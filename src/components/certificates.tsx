...
export function Certificates() {
  ...
  return (
    <section id="certificates" className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8">Мої сертифікати</h2>
      ...
      {selectedImage && (
        ...
        >
          <div className="relative w-full max-w-4xl h-auto aspect-[4/3] animate-fadeIn">
            <Image
              src="https://cdn2.specialist.ru/content/image/simplepage/sert-2019-newyear.jpg"
